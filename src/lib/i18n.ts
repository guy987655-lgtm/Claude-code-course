...
const translations = {
  he: {
    ...
    faq3A: "כן! המחירים נטענים בזמן אמת מהשוק האמריקאי דרך Yahoo Finance, ומתעדכנים כל כמה שניות לאורך הסשן כדי לשקף את תנועות השוק.",
  ...
  en: {
    ...
    faq3A: "Yes! Prices are loaded in real time from the US market via Yahoo Finance, and update every few seconds throughout your session to reflect live market movements.",
